    ...
    <div className="mb-4 rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm leading-7 text-gray-700 shadow-sm">
      ...
      <ul className="mt-3 list-disc pr-5 space-y-2">
        ...
        <li>
          ...
          روبه‌روی فیلد ساعت پایان کلیک کنید تا فهرست درمانگرها و اتاق‌های خالی
          در آن تاریخ و ساعت نمایش داده شود.
        </li>
        <li>
          در صورتی که در زمان انتخاب‌شده درمانگری موجود باشد، خدمات مربوط به آن
          درمانگر به‌همراه مبلغ خدمت و مبلغ قابل پرداخت، به‌صورت خودکار نمایش
          داده می‌شود.
        </li>
        <li>
