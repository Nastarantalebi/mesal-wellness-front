...
function DisclosureButton({
  ...
  useEffect(() => {
    if (group.selectedIndex !== disclosure.key) {
      disclosure.close();
    }
  }, [group.selectedIndex, disclosure]);
  ...
  return (
    <HeadlessDisclosure.Button
      ...
      onClick={() => group.setSelectedIndex(disclosure.key)}
      {...props}
    >
      {children}
    </HeadlessDisclosure.Button>
...
// اتصال کامپوننت‌های فرعی به شیء اصلی
